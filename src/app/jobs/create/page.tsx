...
export default function CreateJobPage() {
    ...
    const { data: companies, isLoading: isLoadingCompanies } = useQuery({
        ...
        queryFn: () => instance.get('/api/pages/me').then(res => res.data)
    });
    ...
    const { mutate: createJob, isPending: isSubmitting } = useMutation({
        mutationFn: (data: JobFormData) =>
            instance.post("/api/recruitment-posts", data).then(res => res.data),
        onSuccess: (data) => {
                        ...
                        <div className="w-[400px] sticky top-8">
                            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                                ...
                                <JobPreviewCard
                                    ...
                                    company={companies?.find((c: Company) => c.id === formValues.pageId)?.name || "Tên công ty"}
