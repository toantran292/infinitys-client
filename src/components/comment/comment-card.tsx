...
export const CommentCard = ({
  ...
  const { data: reactCommentStatus, isLoading: isLoadingReactCommentStatus } =
    useQuery<ReactStatus>({
  ...
  const displayReactCount =
    reactCommentStatus?.react_count || comment.react_count;
              ...
              >
                <ThumbsUp
                  ...
                  className={`transition-transform ${
                    reactCommentStatus?.isActive ? "fill-current" : ""
