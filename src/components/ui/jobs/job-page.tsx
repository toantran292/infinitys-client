...
import { Search, MapPin, Clock, Briefcase, ChevronLeft, ChevronRight } from "lucide-react";
    ...
    return (
        <div className="min-h-screen flex flex-col">
                    ...
                    <div className="grid grid-cols-12 gap-4">
                        ...
                        <div className="col-span-3 space-y-4">
                            ...
                            {isLoading ? (
                                ...
                                <ProfileCard
                                    ...
                                    avatar={profile.avatar?.url || "https://github.com/shadcn.png"}
                        ...
                        <div className="col-span-9 space-y-6">
                                        ...
                                        <div className="flex items-center justify-between px-4 py-3 border-t">
                                            <div className="flex items-center gap-2">
                                                <p className="text-sm text-gray-700">
                                                    {total > 0 ? (
                                                        <>
                                                            Hiển thị <span className="font-medium">{(page - 1) * take + 1}</span> đến{" "}
                                                            <span className="font-medium">{Math.min(page * take, total)}</span> trong{" "}
                            ...
                            <div className="rounded-lg border p-4">
                                <h2 className="font-semibold mb-4">Explore with job collections</h2>
            ...
            <Dialog
                ...
                onOpenChange={setShowNoCompanyDialog}
            >
                <DialogContent className="bg-white">
                    ...
                    <div className="flex justify-end">
                        <Button onClick={() => setShowNoCompanyDialog(false)} className="bg-black hover:bg-gray-800 text-white px-6">
                            Đóng
                        </Button>
                    </div>
                </DialogContent>
