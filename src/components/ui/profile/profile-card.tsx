...
import { BookOpen, Mail, MapPin, GraduationCap, BriefcaseIcon } from "lucide-react";
...
export function ProfileCard({ name, avatar, location, email, major }: ProfileCardProps) {
    return (
